...
*/
insert into favorito values (1, 5);
...
insert into cuenta_premium values (1, "platino", 2);
insert into cuenta_premium values (2, "platino", 1);
insert into cuenta_premium values (3, "platino", 4);
