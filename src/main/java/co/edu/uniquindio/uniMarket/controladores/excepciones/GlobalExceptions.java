...
public class GlobalExceptions {
    ...
    public ResponseEntity<MensajeDTO> badCredentailsException(BadCredentialsException e){
    ...
    public ResponseEntity<MensajeDTO> accesDeniedException(AccessDeniedException accessDeniedException){
    ...
    public ResponseEntity<MensajeDTO> throwAttributeException(AttributeException e){
        return ResponseEntity.badRequest().body( new
                MensajeDTO(HttpStatus.BAD_REQUEST, true, e.getMessage()));
    }
    ...
    public ResponseEntity<MensajeDTO> validationException(MethodArgumentNotValidException ex){
        ...
        return ResponseEntity.badRequest().body( new
                MensajeDTO(HttpStatus.BAD_REQUEST, true, messages.toString()));
    }
}
